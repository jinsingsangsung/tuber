...
def load_detr_weights(model, pretrain_dir, cfg):
    ...
    if cfg.DDP_CONFIG.DISTRIBUTED:
        pretrained_dict_ = {"module."+k: v for k, v in pretrained_dict.items() if "module."+k in model_dict} # model_dict에는 "module.query_embed.weight"라는 key가 있음
