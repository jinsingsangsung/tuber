...
class DETR(nn.Module):
    ...
    def __init__(self, backbone, transformer, transformer2, num_classes, num_queries, num_frames,
                 hidden_dim, temporal_length, aux_loss=False, generate_lfb=False, two_stage=False, random_refpoints_xy=False, query_dim=4, num_feature_levels=4,
...
def build_model(cfg):
    ...
    transformer2 = build_deformable_transformer(cfg)
