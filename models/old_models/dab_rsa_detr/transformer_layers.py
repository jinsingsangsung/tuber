...
class TransformerEncoder(nn.Module):
    """
    takes
    spatially-mixed src: hw, bs*t, c
    orig_shape: bs, c, t, h, w
    mask: bs*t, hw
    pos: hw, bs*t, c
    """
    def __init__(self, encoder_layer, num_layers, d_model=256, dim_feedforward=2048, dropout=0.1, activation='relu'):
        super().__init__()
...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward(self, src, orig_shape,
        ...
        return self.forward_post(src, orig_shape, src_key_padding_mask, pos)
