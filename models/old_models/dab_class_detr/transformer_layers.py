...
import math
from .dab_transformer import MLP
...
class TransformerDecoder(nn.Module):
    ...
    def __init__(self, decoder_layer, num_layers, norm=None):
        ...
        self.ce_proj = _get_clones(MLP(d_model, d_model, d_model, 2), 2*num_layers)
        self.cross_attn = nn.MultiheadAttention(d_model, 4, dropout=0.1, vdim=d_model)

    def forward(self, tgt: Tensor, memory: Tensor, class_embed: Tensor, tgt_mask: Optional[Tensor] = None,
