...
class SetCriterionAVA(nn.Module):
    ...
    def loss_labels(self, outputs, targets, indices, num_boxes, log=True):
        ...
        try:
            ...
            target_classes_o_ = target_classes_o.sum(-2).clamp(0,1) 
            loss_ce_b = F.cross_entropy(src_logits_b.transpose(1, 2), target_classes_o_, self.empty_weight.to(src_logits.device))
        except:
            pass
        ...
        # for i in idx:
            ...
            # target_classes[i] = target_classes_o
