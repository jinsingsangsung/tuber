...
def build_model(cfg):
    if cfg.CONFIG.DATA.DATASET_NAME == 'ava':
        from models.dab_rsa_detr.matcher import build_matcher
    elif cfg.CONFIG.DATA.DATASET_NAME == 'jhmdb':
        from models.dab_rsa_detr.matcher_ucf import build_matcher
    else:
        from models.dab_rsa_detr.matcher_ucf_ import build_matcher
