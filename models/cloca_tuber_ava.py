...
from models.cloca_transformer.transformer import build_transformer, build_transformer2
from models.cloca_transformer.transformer_layers import TransformerEncoderLayer, TransformerEncoder, TransformerDecoder, TransformerDecoderLayer
from models.cloca_transformer.criterion import SetCriterion, PostProcess, SetCriterionAVA, PostProcessAVA, MLP
...
class DETR(nn.Module):
    ...
    def forward(self, samples: NestedTensor):
        ...
        hs, enc_feature, _, attn_decoder = self.transformer(self.input_proj(src), mask, self.query_embed.weight, pos[-1])
        hs2, dec_attn = self.transformer2(enc_feature, mask, self.loc_query_embed.weight, pos[-1], attn_decoder)
