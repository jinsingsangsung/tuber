...
from models.dfwsgar.res_50 import build_Res50
...
class Backbone(nn.Module):
    ...
    def __init__(self, train_backbone: bool, num_channels: int, position_embedding, cfg):
        ...
        if cfg.CONFIG.MODEL.BACKBONE_NAME == 'resnet50':
            print("resnet50 backbone")
            self.body = build_Res50(cfg)
        else:
            raise AssertionError("no valid backbone")
